        ...
        if (formIsValid) {
            ...
            axios
                ...
                .then((response) => {
                    ...
                    setBalance(response.data.balance)
                    window.location.href = `/admin/viewaccount/${id}`;
                })
                .catch((error) => {
                    console.error(error);
                                ...
                                <CardContent>
                                    <Row>
                                        <Col style={{ display: "flex", justifyContent: "space-between" }}>
                                            <h4><strong style={{ color: "#5ab769" }}>COURSE: {studentdetail.course?.name} </strong></h4>
                                            <h5><strong style={{ color: "#5ab769" }}>[{studentdetail.batch?.batchname}]</strong></h5>
                                        </Col>
                                    </Row>
                                    <Row>
                                        <Col className='col-3'>
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style={{ display: "flex", justifyContent: "space-evenly" }}>
                                                            <b>Balance: </b>{balance}
                                                            {balance === 0 && <span style={{ color: "green" }}>Payment successful!</span>}
                                                            {balance !== 0 && studentdetail.coursefee > data.reduce((total, item) => total + parseFloat(item.amount), 0).toFixed(2) && <span style={{ color: "orange" }}>Payment Pending!</span>}
                                                            {balance !== 0 && studentdetail.coursefee < data.reduce((total, item) => total + parseFloat(item.amount), 0).toFixed(2) && <span style={{ color: "red" }}>Payment Overflow!</span>}
                                                        </td>
                                                    </tr>
                                                </tbody>
                                            </table>
